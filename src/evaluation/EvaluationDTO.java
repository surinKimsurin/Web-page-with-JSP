...
public class EvaluationDTO {
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			String semeterDivide, String lectureDivide, String evaluationTitle, String evaluationContent,
		...
		this.semeterDivide = semeterDivide;
	...
	public String getSemeterDivide() {
		return semeterDivide;
	}
	public void setSemeterDivide(String semeterDivide) {
		this.semeterDivide = semeterDivide;
	}
