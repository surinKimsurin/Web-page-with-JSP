 ...
 -->
    ...
    <div class="bueno-post-area mb-70">
        <div class="container">
 		 ...
 		 <form name="modForm" method="post" enctype="multipart/form-data" action="${contextPath}/post/modPost.do/${post_articleNO}"  >
	     ...
	     <tr>
			   ...
			   <td colspan="2"><input type="text" size="67"  maxlength="500" name="post_title" value=${post_title }></td>
		 </tr>
	 		<tr>
				<td align="right" valign="top"><br>글내용: </td>
				<td colspan=2><textarea name="post_content" rows="10" cols="65" maxlength="4000" >${post_content }</textarea> </td>
     </tr>
     <tr>
